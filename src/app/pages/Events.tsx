...
import { Calendar, Clock, MapPin, Users, Briefcase, GraduationCap, Award, Plane, Loader2 } from 'lucide-react';
                      ...
                      <div className="grid sm:grid-cols-2 gap-4 mb-6">
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-white">{event.time || 'TBD'}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-white">
                              {event.registered_members?.length || 0} / {event.max_participants || '∞'} registered
                            </div>
                          </div>
                        </div>
                      </div>
